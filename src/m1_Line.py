...
class Line(object):
    ...
    def length(self):
        ...
        #        They include the Example in the above doc-string.
        # ---------------------------------------------------------------------
        return Point.distance_from(self.start,self.end)
    ...
    def midpoint(self):
        ...
        midpointx=(self.end.x-self.start.x)/2+self.start.x
        midpointy=(self.end.y-self.start.y)/2+self.start.y
