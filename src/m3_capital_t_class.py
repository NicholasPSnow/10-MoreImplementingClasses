    ...
    *** See the PDFs, especially dimensions.pdf, to help you understand this.
    ...
    def __init__(self, intersection_center, width, height, letter_thickness):
        ...
        *** See   dimensions.pdf   to understand the following! ***
        ...
        corner3=rg.Point(intersection_center.x-letter_thickness/2,intersection_center.y-letter_thickness/2)
        corner4=rg.Point(intersection_center.x+letter_thickness/2,intersection_center.y+height-letter_thickness/2)
    ...
    def clone(self):
        ...
        #######################################################################
        instruction_center = self.h_rect.get_center()
        width = abs(self.h_rect.corner_1.x - self.h_rect.corner_2.x)
        height = abs(self.v_rect.corner_1.y - self.v_rect.corner_2.y)
        thickness = abs(self.h_rect.corner_1.y - self.h_rect.corner_2.y)
        name = CapitalT(instruction_center, width, height, thickness)
        name.set_colors(self.v_rect.fill_color, self.h_rect.outline_color)
        return name
